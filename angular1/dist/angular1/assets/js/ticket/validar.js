...
var alerta = (fondo,fondo1,texto,llaves) => {
    ...
    setTimeout(()=>{
        toasts.style.backgroundColor = "white";
...
formulario.addEventListener('submit', (e) => {
    ...
    var select1 = document.getElementById('f_info_select1');
    var select2 = document.getElementById('f_info_select2');
    var select3 = document.getElementById('f_info_select3');
    ...
    if(datoCampo.f_namecom[0] && datoCampo.f_curp[0] && datoCampo.f_name[0] && datoCampo.f_pate[0] 
       ...
       && select1.value != '' && select2.value != '' && select3.value != ''){
        ...
        if(validarcurp(datoCampo)){
            ...
            if(edad >= 3 && edad <= 6 && select1.value === "Preescolar"){
                alerta('green','#48F01B','Formulario Completado',llaves);
            }
            else if(edad >= 6 && edad <= 12 && select1.value === "Primaria"){
                alerta('green','#48F01B','Formulario Completado',llaves);
            }
            else if(edad >= 12 && edad <= 15 && select1.value === "Secundaria"){
                alerta('green','#48F01B','Formulario Completado',llaves);
            }
            else{
